...
public class FiltPickScreen extends AbstractContainerScreen<FiltPickMenu> {
    ...
    private void addScrollBlock() {
        scrollBlock = new ContainerScrollBlock(
                ...
                topPos + 17,
                FiltPick.SERVER_CONFIG.FILTLIST_DISPLAYED_ROW_COUNT.get() * 18,
                FiltPick.SERVER_CONFIG.FILTLIST_DISPLAYED_ROW_COUNT.get(),
    ...
    private void initCoordinates() {
        this.imageHeight = 114 + FiltPick.SERVER_CONFIG.FILTLIST_DISPLAYED_ROW_COUNT.get() * 18;
    ...
    private void renderInventory(GuiGraphics context) {
        context.blit(CONTAINER_BACKGROUND, leftPos, topPos + FiltPick.SERVER_CONFIG.FILTLIST_DISPLAYED_ROW_COUNT.get() * 18 + 17, 0, 126, imageWidth, 96);
    }

    private void renderFiltPickContainer(GuiGraphics context) {
        context.blit(CONTAINER_BACKGROUND, leftPos, topPos, 0, 0, imageWidth, FiltPick.SERVER_CONFIG.FILTLIST_DISPLAYED_ROW_COUNT.get() * 18 + 17);
    }
